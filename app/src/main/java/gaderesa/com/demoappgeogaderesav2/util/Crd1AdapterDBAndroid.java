...
public class Crd1AdapterDBAndroid extends BaseAdapter {
    ArrayList<Crd1> crd1List = new ArrayList<Crd1>();
    Context context;

    public Crd1AdapterDBAndroid(Context context, ArrayList<Crd1> crd1List) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Crd1ViewHolderDBAndroid view = (Crd1ViewHolderDBAndroid) convertView;
        if (view == null) {
            view = new Crd1ViewHolderDBAndroid(context);
        }
